  ...
  return (
    <section className="hero d-flex justify-content-center align-items-center" id="section_1">
          ...
          <div className="col-lg-7 col-12">
            <div className="hero-text">
              <div className="hero-title-wrap d-flex align-items-center mb-4">
                ...
                <img src="/images/itelis-ava.png" className="avatar-image avatar-image-large img-fluid" alt="itelis" />
                <h1 className="hero-title ms-3 mb-0">itelis </h1>
              </div>

              <h2 className="mb-4">Available for freelance work.</h2>

              <p className="mb-4">
                <a className="custom-btn btn custom-link me-2" href="#section_4">See Projects</a>
                <a className="custom-btn custom-border-btn btn" href="#section_5">Contact</a>
              </p>
            </div>
          </div>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path fill="var(--primary-color)" fillOpacity="1"
